...
![A janela do Home Assistant no bloco «Integrações» do portal](../../img/iheater-ha-portal-integration.png)
...
![Raw configuration editor com o layout colado](../../img/iheater-ha-raw-editor.png)
